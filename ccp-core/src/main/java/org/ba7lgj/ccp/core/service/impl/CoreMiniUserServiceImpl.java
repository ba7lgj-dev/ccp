...
import org.ba7lgj.ccp.core.mapper.CoreMiniUserMapper;
 ...
 */
@Service
public class CoreMiniUserServiceImpl implements CoreMiniUserService {

    @Resource
    private CoreMiniUserMapper miniUserMapper;
